package com.icure.fhir.mapping.domain.fhir.xml
...
class FloatStringDeserializer : com.fasterxml.jackson.databind.JsonDeserializer<FloatString?>() {
...
class FloatStringSerializer : com.fasterxml.jackson.databind.JsonSerializer<FloatString>() {
	override fun serialize(
		value: FloatString,
		gen: JsonGenerator,
