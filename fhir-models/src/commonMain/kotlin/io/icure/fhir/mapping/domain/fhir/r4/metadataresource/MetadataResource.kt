...
//
package io.icure.fhir.mapping.domain.fhir.r4.metadataresource
 ...
 * @param url Canonical identifier for this metadata resource, represented as a URI (globally
 * unique)
 * @param version Business version of the metadata resource
 * @param name Name for this metadata resource (computer friendly)
 * @param title Name for this metadata resource (human friendly)
 * @param status draft | active | retired | unknown
 * @param experimental For testing purposes, not real usage
 * @param date Date last changed
 * @param publisher Name of the publisher (organization or individual)
 * @param description Natural language description of the metadata resource
 */
