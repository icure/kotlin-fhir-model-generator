...
import io.icure.fhir.mapping.domain.fhir.r6.account.Account
import io.icure.fhir.mapping.domain.fhir.r6.activitydefinition.ActivityDefinition
import io.icure.fhir.mapping.domain.fhir.r6.actordefinition.ActorDefinition
import io.icure.fhir.mapping.domain.fhir.r6.administrableproductdefinition.AdministrableProductDefinition
import io.icure.fhir.mapping.domain.fhir.r6.adverseevent.AdverseEvent
import io.icure.fhir.mapping.domain.fhir.r6.age.Age
import io.icure.fhir.mapping.domain.fhir.r6.allergyintolerance.AllergyIntolerance
import io.icure.fhir.mapping.domain.fhir.r6.appointment.Appointment
import io.icure.fhir.mapping.domain.fhir.r6.appointmentresponse.AppointmentResponse
import io.icure.fhir.mapping.domain.fhir.r6.artifactassessment.ArtifactAssessment
import io.icure.fhir.mapping.domain.fhir.r6.auditevent.AuditEvent
import io.icure.fhir.mapping.domain.fhir.r6.basic.Basic
import io.icure.fhir.mapping.domain.fhir.r6.binary.Binary
import io.icure.fhir.mapping.domain.fhir.r6.biologicallyderivedproduct.BiologicallyDerivedProduct
import io.icure.fhir.mapping.domain.fhir.r6.biologicallyderivedproductdispense.BiologicallyDerivedProductDispense
import io.icure.fhir.mapping.domain.fhir.r6.bodystructure.BodyStructure
import io.icure.fhir.mapping.domain.fhir.r6.bundle.Bundle
import io.icure.fhir.mapping.domain.fhir.r6.canonicalresource.CanonicalResource
import io.icure.fhir.mapping.domain.fhir.r6.capabilitystatement.CapabilityStatement
import io.icure.fhir.mapping.domain.fhir.r6.careplan.CarePlan
import io.icure.fhir.mapping.domain.fhir.r6.careteam.CareTeam
import io.icure.fhir.mapping.domain.fhir.r6.chargeitem.ChargeItem
import io.icure.fhir.mapping.domain.fhir.r6.chargeitemdefinition.ChargeItemDefinition
import io.icure.fhir.mapping.domain.fhir.r6.citation.Citation
import io.icure.fhir.mapping.domain.fhir.r6.claim.Claim
import io.icure.fhir.mapping.domain.fhir.r6.claimresponse.ClaimResponse
import io.icure.fhir.mapping.domain.fhir.r6.clinicalimpression.ClinicalImpression
import io.icure.fhir.mapping.domain.fhir.r6.clinicalusedefinition.ClinicalUseDefinition
import io.icure.fhir.mapping.domain.fhir.r6.codesystem.CodeSystem
import io.icure.fhir.mapping.domain.fhir.r6.communication.Communication
import io.icure.fhir.mapping.domain.fhir.r6.communicationrequest.CommunicationRequest
import io.icure.fhir.mapping.domain.fhir.r6.compartmentdefinition.CompartmentDefinition
import io.icure.fhir.mapping.domain.fhir.r6.composition.Composition
import io.icure.fhir.mapping.domain.fhir.r6.conceptmap.ConceptMap
import io.icure.fhir.mapping.domain.fhir.r6.condition.Condition
import io.icure.fhir.mapping.domain.fhir.r6.conditiondefinition.ConditionDefinition
import io.icure.fhir.mapping.domain.fhir.r6.consent.Consent
import io.icure.fhir.mapping.domain.fhir.r6.contract.Contract
import io.icure.fhir.mapping.domain.fhir.r6.count.Count
import io.icure.fhir.mapping.domain.fhir.r6.coverage.Coverage
import io.icure.fhir.mapping.domain.fhir.r6.coverageeligibilityrequest.CoverageEligibilityRequest
import io.icure.fhir.mapping.domain.fhir.r6.coverageeligibilityresponse.CoverageEligibilityResponse
import io.icure.fhir.mapping.domain.fhir.r6.detectedissue.DetectedIssue
import io.icure.fhir.mapping.domain.fhir.r6.device.Device
import io.icure.fhir.mapping.domain.fhir.r6.deviceassociation.DeviceAssociation
import io.icure.fhir.mapping.domain.fhir.r6.devicedefinition.DeviceDefinition
import io.icure.fhir.mapping.domain.fhir.r6.devicedispense.DeviceDispense
import io.icure.fhir.mapping.domain.fhir.r6.devicemetric.DeviceMetric
import io.icure.fhir.mapping.domain.fhir.r6.devicerequest.DeviceRequest
import io.icure.fhir.mapping.domain.fhir.r6.deviceusage.DeviceUsage
import io.icure.fhir.mapping.domain.fhir.r6.diagnosticreport.DiagnosticReport
import io.icure.fhir.mapping.domain.fhir.r6.distance.Distance
import io.icure.fhir.mapping.domain.fhir.r6.documentreference.DocumentReference
import io.icure.fhir.mapping.domain.fhir.r6.duration.Duration
import io.icure.fhir.mapping.domain.fhir.r6.encounter.Encounter
import io.icure.fhir.mapping.domain.fhir.r6.encounterhistory.EncounterHistory
import io.icure.fhir.mapping.domain.fhir.r6.endpoint.Endpoint
import io.icure.fhir.mapping.domain.fhir.r6.enrollmentrequest.EnrollmentRequest
import io.icure.fhir.mapping.domain.fhir.r6.enrollmentresponse.EnrollmentResponse
import io.icure.fhir.mapping.domain.fhir.r6.episodeofcare.EpisodeOfCare
import io.icure.fhir.mapping.domain.fhir.r6.eventdefinition.EventDefinition
import io.icure.fhir.mapping.domain.fhir.r6.evidence.Evidence
import io.icure.fhir.mapping.domain.fhir.r6.evidencereport.EvidenceReport
import io.icure.fhir.mapping.domain.fhir.r6.evidencevariable.EvidenceVariable
import io.icure.fhir.mapping.domain.fhir.r6.examplescenario.ExampleScenario
import io.icure.fhir.mapping.domain.fhir.r6.explanationofbenefit.ExplanationOfBenefit
import io.icure.fhir.mapping.domain.fhir.r6.familymemberhistory.FamilyMemberHistory
import io.icure.fhir.mapping.domain.fhir.r6.flag.Flag
import io.icure.fhir.mapping.domain.fhir.r6.formularyitem.FormularyItem
import io.icure.fhir.mapping.domain.fhir.r6.genomicstudy.GenomicStudy
import io.icure.fhir.mapping.domain.fhir.r6.goal.Goal
import io.icure.fhir.mapping.domain.fhir.r6.graphdefinition.GraphDefinition
import io.icure.fhir.mapping.domain.fhir.r6.group.Group
import io.icure.fhir.mapping.domain.fhir.r6.guidanceresponse.GuidanceResponse
import io.icure.fhir.mapping.domain.fhir.r6.healthcareservice.HealthcareService
import io.icure.fhir.mapping.domain.fhir.r6.imagingselection.ImagingSelection
import io.icure.fhir.mapping.domain.fhir.r6.imagingstudy.ImagingStudy
import io.icure.fhir.mapping.domain.fhir.r6.immunization.Immunization
import io.icure.fhir.mapping.domain.fhir.r6.immunizationevaluation.ImmunizationEvaluation
import io.icure.fhir.mapping.domain.fhir.r6.immunizationrecommendation.ImmunizationRecommendation
import io.icure.fhir.mapping.domain.fhir.r6.implementationguide.ImplementationGuide
import io.icure.fhir.mapping.domain.fhir.r6.ingredient.Ingredient
import io.icure.fhir.mapping.domain.fhir.r6.insuranceplan.InsurancePlan
import io.icure.fhir.mapping.domain.fhir.r6.insuranceproduct.InsuranceProduct
import io.icure.fhir.mapping.domain.fhir.r6.inventoryitem.InventoryItem
import io.icure.fhir.mapping.domain.fhir.r6.inventoryreport.InventoryReport
import io.icure.fhir.mapping.domain.fhir.r6.invoice.Invoice
import io.icure.fhir.mapping.domain.fhir.r6.library.Library
import io.icure.fhir.mapping.domain.fhir.r6.linkage.Linkage
import io.icure.fhir.mapping.domain.fhir.r6.location.Location
import io.icure.fhir.mapping.domain.fhir.r6.manufactureditemdefinition.ManufacturedItemDefinition
import io.icure.fhir.mapping.domain.fhir.r6.measure.Measure
import io.icure.fhir.mapping.domain.fhir.r6.measurereport.MeasureReport
import io.icure.fhir.mapping.domain.fhir.r6.medication.Medication
import io.icure.fhir.mapping.domain.fhir.r6.medicationadministration.MedicationAdministration
import io.icure.fhir.mapping.domain.fhir.r6.medicationdispense.MedicationDispense
import io.icure.fhir.mapping.domain.fhir.r6.medicationknowledge.MedicationKnowledge
import io.icure.fhir.mapping.domain.fhir.r6.medicationrequest.MedicationRequest
import io.icure.fhir.mapping.domain.fhir.r6.medicationstatement.MedicationStatement
import io.icure.fhir.mapping.domain.fhir.r6.medicinalproductdefinition.MedicinalProductDefinition
import io.icure.fhir.mapping.domain.fhir.r6.messagedefinition.MessageDefinition
import io.icure.fhir.mapping.domain.fhir.r6.messageheader.MessageHeader
import io.icure.fhir.mapping.domain.fhir.r6.metadataresource.MetadataResource
import io.icure.fhir.mapping.domain.fhir.r6.molecularsequence.MolecularSequence
import io.icure.fhir.mapping.domain.fhir.r6.namingsystem.NamingSystem
import io.icure.fhir.mapping.domain.fhir.r6.nutritionintake.NutritionIntake
import io.icure.fhir.mapping.domain.fhir.r6.nutritionorder.NutritionOrder
import io.icure.fhir.mapping.domain.fhir.r6.nutritionproduct.NutritionProduct
import io.icure.fhir.mapping.domain.fhir.r6.observation.Observation
import io.icure.fhir.mapping.domain.fhir.r6.observationdefinition.ObservationDefinition
import io.icure.fhir.mapping.domain.fhir.r6.operationdefinition.OperationDefinition
import io.icure.fhir.mapping.domain.fhir.r6.operationoutcome.OperationOutcome
import io.icure.fhir.mapping.domain.fhir.r6.organization.Organization
import io.icure.fhir.mapping.domain.fhir.r6.organizationaffiliation.OrganizationAffiliation
import io.icure.fhir.mapping.domain.fhir.r6.packagedproductdefinition.PackagedProductDefinition
import io.icure.fhir.mapping.domain.fhir.r6.parameters.Parameters
import io.icure.fhir.mapping.domain.fhir.r6.patient.Patient
import io.icure.fhir.mapping.domain.fhir.r6.paymentnotice.PaymentNotice
import io.icure.fhir.mapping.domain.fhir.r6.paymentreconciliation.PaymentReconciliation
import io.icure.fhir.mapping.domain.fhir.r6.permission.Permission
import io.icure.fhir.mapping.domain.fhir.r6.person.Person
import io.icure.fhir.mapping.domain.fhir.r6.plandefinition.PlanDefinition
import io.icure.fhir.mapping.domain.fhir.r6.practitioner.Practitioner
import io.icure.fhir.mapping.domain.fhir.r6.practitionerrole.PractitionerRole
import io.icure.fhir.mapping.domain.fhir.r6.procedure.Procedure
import io.icure.fhir.mapping.domain.fhir.r6.provenance.Provenance
import io.icure.fhir.mapping.domain.fhir.r6.questionnaire.Questionnaire
import io.icure.fhir.mapping.domain.fhir.r6.questionnaireresponse.QuestionnaireResponse
import io.icure.fhir.mapping.domain.fhir.r6.regulatedauthorization.RegulatedAuthorization
import io.icure.fhir.mapping.domain.fhir.r6.relatedperson.RelatedPerson
import io.icure.fhir.mapping.domain.fhir.r6.requestorchestration.RequestOrchestration
import io.icure.fhir.mapping.domain.fhir.r6.requirements.Requirements
import io.icure.fhir.mapping.domain.fhir.r6.researchstudy.ResearchStudy
import io.icure.fhir.mapping.domain.fhir.r6.researchsubject.ResearchSubject
import io.icure.fhir.mapping.domain.fhir.r6.riskassessment.RiskAssessment
import io.icure.fhir.mapping.domain.fhir.r6.schedule.Schedule
import io.icure.fhir.mapping.domain.fhir.r6.searchparameter.SearchParameter
import io.icure.fhir.mapping.domain.fhir.r6.servicerequest.ServiceRequest
import io.icure.fhir.mapping.domain.fhir.r6.slot.Slot
import io.icure.fhir.mapping.domain.fhir.r6.specimen.Specimen
import io.icure.fhir.mapping.domain.fhir.r6.specimendefinition.SpecimenDefinition
import io.icure.fhir.mapping.domain.fhir.r6.structuredefinition.StructureDefinition
import io.icure.fhir.mapping.domain.fhir.r6.structuremap.StructureMap
import io.icure.fhir.mapping.domain.fhir.r6.subscription.Subscription
import io.icure.fhir.mapping.domain.fhir.r6.subscriptionstatus.SubscriptionStatus
import io.icure.fhir.mapping.domain.fhir.r6.subscriptiontopic.SubscriptionTopic
import io.icure.fhir.mapping.domain.fhir.r6.substance.Substance
import io.icure.fhir.mapping.domain.fhir.r6.substancedefinition.SubstanceDefinition
import io.icure.fhir.mapping.domain.fhir.r6.substancenucleicacid.SubstanceNucleicAcid
import io.icure.fhir.mapping.domain.fhir.r6.substancepolymer.SubstancePolymer
import io.icure.fhir.mapping.domain.fhir.r6.substanceprotein.SubstanceProtein
import io.icure.fhir.mapping.domain.fhir.r6.substancereferenceinformation.SubstanceReferenceInformation
import io.icure.fhir.mapping.domain.fhir.r6.substancesourcematerial.SubstanceSourceMaterial
import io.icure.fhir.mapping.domain.fhir.r6.supplydelivery.SupplyDelivery
import io.icure.fhir.mapping.domain.fhir.r6.supplyrequest.SupplyRequest
import io.icure.fhir.mapping.domain.fhir.r6.task.Task
import io.icure.fhir.mapping.domain.fhir.r6.terminologycapabilities.TerminologyCapabilities
import io.icure.fhir.mapping.domain.fhir.r6.testplan.TestPlan
import io.icure.fhir.mapping.domain.fhir.r6.testreport.TestReport
import io.icure.fhir.mapping.domain.fhir.r6.testscript.TestScript
import io.icure.fhir.mapping.domain.fhir.r6.transport.Transport
import io.icure.fhir.mapping.domain.fhir.r6.valueset.ValueSet
import io.icure.fhir.mapping.domain.fhir.r6.verificationresult.VerificationResult
import io.icure.fhir.mapping.domain.fhir.r6.visionprescription.VisionPrescription
...
public object QuantitySerializer : KSerializer<Quantity> {
  override val descriptor: SerialDescriptor =
      io.icure.fhir.mapping.domain.fhir.r6.quantity.Quantity.serializer().descriptor


  override fun deserialize(decoder: Decoder): Quantity =
      decoder.decodeSerializableValue(io.icure.fhir.mapping.domain.fhir.r6.quantity.Quantity.serializer())
  ...
  override fun serialize(encoder: Encoder, `value`: Quantity): Unit = when (value) {
    ...
    is io.icure.fhir.mapping.domain.fhir.r6.quantity.Quantity ->
        io.icure.fhir.mapping.domain.fhir.r6.quantity.Quantity.serializer().serialize(encoder,
        value)
