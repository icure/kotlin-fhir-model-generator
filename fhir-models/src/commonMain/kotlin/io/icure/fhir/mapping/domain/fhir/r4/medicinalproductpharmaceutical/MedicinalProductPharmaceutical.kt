...
public data class MedicinalProductPharmaceutical(
  ...
  public val characteristics: List<MedicinalProductPharmaceuticalCharacteristics> = emptyList(),
  public val routeOfAdministration: List<MedicinalProductPharmaceuticalRouteOfAdministration> =
      emptyList(),
) : DomainResource
