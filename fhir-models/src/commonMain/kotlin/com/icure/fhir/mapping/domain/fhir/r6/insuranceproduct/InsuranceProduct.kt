 ...
 */
@SerialName("InsuranceProduct")
@Serializable
public data class InsuranceProduct(
  /**
  ...
  public val coverage: List<InsuranceProductCoverage> = emptyList(),
  public val related: List<InsuranceProductRelated> = emptyList(),
) : DomainResource
