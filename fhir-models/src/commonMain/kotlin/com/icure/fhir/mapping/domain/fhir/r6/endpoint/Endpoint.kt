...
//
package com.icure.fhir.mapping.domain.fhir.r6.endpoint
 ...
 * @param status active | suspended | error | off | entered-in-error
 ...
 * @param availability Times the endpoint is expected to be available (including exceptions)
