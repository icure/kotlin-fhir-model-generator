...
//
package com.icure.fhir.mapping.domain.fhir.r6.activitydefinition
...
public data class ActivityDefinition(
  ...
  public val specimenRequirement: List<String> = emptyList(),
  public val observationRequirement: List<String> = emptyList(),
  public val observationResultRequirement: List<String> = emptyList(),
  /**
