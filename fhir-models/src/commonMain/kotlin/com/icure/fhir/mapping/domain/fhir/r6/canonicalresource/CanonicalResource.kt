...
//
package com.icure.fhir.mapping.domain.fhir.r6.canonicalresource
 ...
 * @param url Canonical identifier for this {{title}}, represented as an absolute URI (globally
 * unique)
 * @param version Business version of the {{title}}
 ...
 * @param title Name for this {{title}} (human friendly)
 * @param status draft | active | retired | unknown
 * @param experimental For testing purposes, not real usage
 * @param date Date last changed
 * @param publisher Name of the publisher/steward (organization or individual)
 * @param description Natural language description of the {{title}}
 * @param purpose Why this {{title}} is defined
 * @param copyright Use and/or publishing restrictions
 * @param copyrightLabel Copyright holder and year(s)
 */
@SerialName("CanonicalResource")
@Serializable
public data class CanonicalResource(
  /**
