...
//
package com.icure.fhir.mapping.domain.fhir.r4.evidence
 ...
 * @param url Canonical identifier for this evidence, represented as a URI (globally unique)
 * @param version Business version of the evidence
 * @param name Name for this evidence (computer friendly)
 * @param title Name for this evidence (human friendly)
 * @param shortTitle Title for use in informal contexts
 * @param subtitle Subordinate title of the Evidence
 * @param status draft | active | retired | unknown
 * @param date Date last changed
 * @param publisher Name of the publisher (organization or individual)
 * @param description Natural language description of the evidence
 * @param copyright Use and/or publishing restrictions
 * @param approvalDate When the evidence was approved by publisher
 * @param lastReviewDate When the evidence was last reviewed
 * @param effectivePeriod When the evidence is expected to be used
 * @param exposureBackground What population?
 */
@SerialName("Evidence")
@Serializable
public data class Evidence(
  ...
  public val exposureVariant: List<Reference> = emptyList(),
  public val outcome: List<Reference> = emptyList(),
) : DomainResource
