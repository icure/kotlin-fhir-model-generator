...
//
package com.icure.fhir.mapping.domain.fhir.r5.timing
 ...
 * @param frequency Indicates the number of repetitions that should occur within a period. I.e.
 * Event occurs frequency times per period
 * @param frequencyMax Event occurs up to frequencyMax times per period
 * @param period The duration to which the frequency applies. I.e. Event occurs frequency times per
 * period
...
public data class TimingRepeat(
  ...
  /**
   * Indicates the number of repetitions that should occur within a period. I.e. Event occurs
